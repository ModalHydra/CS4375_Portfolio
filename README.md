...
## Linear Models
Here is the link for the [Weather Linear Regression Model](LinearRegression.pdf)
Here is the link for the [Housing Logistic Regression Model](Classification.pdf)
